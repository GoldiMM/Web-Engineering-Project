	...
	echo "<article>";
		...
		if ($result->num_rows > 0) {
		 	while($row = $result->fetch_assoc()) {
			    ...
			    ?>
			    <td><a href="update.php?id=<?php echo $row[$headers[0]]; ?>"> Change </a></td>	
			    <td><a href="edit_dynamic.php?id=<?php echo $row[$headers[0]]; ?>"> edit (dynamically) </a></td>	
			     <td><a href="delete_dynamic.php?id=<?php echo $row[$headers[0]]; ?>"> Delete (dynamically)</a></td>	
			    <td><a href="delete.php?id=<?php echo $row[$headers[0]]; ?>"> Delete </a></td>	
