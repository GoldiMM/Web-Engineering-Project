<!-- INCLUDE FILE -->
        <aside class="aside">
            <table border="4" cellspacing="5pt" cellpadding="2pt" bgcolor="blue" class="navbar2">
                <tr> 
                    <td>
                        <a href="rechnungen.php"><button type="button"> &Uuml;bersicht der Rechnungen</button></a>
                    </td>
                </tr>
                <tr> 
                    <td>
                        <a href="rechnung_new.php"><button type="button"> Neue Rechnung erfassen </button></a>
                    </td>
                </tr>
                <tr> 
                    <td>
